...
**Source:** Migrated Notion research, meeting notes, and strategy docs
**Use this for:** Finding research evidence, open questions, and pages that support product or GTM decisions.

Back to [Documentation Hub](./README.md).

## Research Map

| Area | Pages | What to look for |
| --- | --- | --- |
...
- Which Cal Poly teams have the strongest immediate sponsor demand?
- Which sponsor categories are most likely to say yes to first deals?
- What minimum team profile data makes a sponsor trust a team?
- What deal sizes are realistic for first conversations?
- What proof of performance do sponsors expect after a deal?
- Which workflows should remain manual until repeated enough times?

## Evidence To Promote

Promote research into [Decision Log](./decision-log.md) when it changes product scope, GTM focus, pricing, team/sponsor definitions, or implementation order.
